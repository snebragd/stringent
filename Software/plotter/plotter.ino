// Version of Stringent by snebragd https://github.com/snebragd
// Roughlhy hacked to work with NodeMCU
// For information see https://github.com/snebragd/stringent
// And https://www.hackster.io/fredrikstridsman/stringent-the-15-wall-plotter-d965ca

#include "MachineDefs.h"

//circumference of spool
#define spoolCirc 37.7
...
void setup()
{
  ...
  Serial.println(disparity);
  Serial.println("stoppedAt=");
  Serial.println(stoppedAt);
  Serial.println("currentPlot=");
  Serial.println(currentPlot);
